...
\033[1;92m     ~~~~Naveed~~~~
\033[1;94m===============================================
\033[1;97m➣ Author : \033[1;97mNaveed
\033[1;97m➣ City : Nahi batoon ga
\033[1;97m➣ WP  : \033[1;97m03226906314
\033[1;94m==============================================="""
...
def menu():
    ...
    print 47 * '-'
    print '\033[1;94m[1] Start Hacking' 
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mNaveed King Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[Naveed_OK]➤ ' + uid + ' | ' + pass2
